...
const ScheduleTeamBodyCard: React.FC<Props> = (props: Props) => {
  return (
        ...
        {props.arrNumber.map((el: any) =>
          props.mainMenu === "Teams"
            ...
            <div
              ...
              key={el}
            >
              <p className="scheduleteambody-card-resident-title">Team V. Hofmann</p>
...
export default ScheduleTeamBodyCard;
